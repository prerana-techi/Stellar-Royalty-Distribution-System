...
export const REGISTRY_CONTRACT_ID = process.env.NEXT_PUBLIC_ROYALTY_REGISTRY_CONTRACT_ID || 'CCYC4OZFAQ63A6JNMZOT4HMPSEUA7L4DKHH7SCOYM2T6RSBF2TCBEVVD';
export const DISTRIBUTOR_CONTRACT_ID = process.env.NEXT_PUBLIC_PAYMENT_DISTRIBUTOR_CONTRACT_ID || 'CD6WDVR26QLJ5URJFLOQND4RDSZCF2EJMJJZEO6C3VLAIEOZRUWEIKHT';
